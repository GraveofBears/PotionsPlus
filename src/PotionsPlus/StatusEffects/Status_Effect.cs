...
namespace PotionsPlus
{
  public partial class PotionsPlus
  {
    ...
    //     {
    //       new() { m_modifier = HitData.DamageModifier.VeryResistant, m_type = HitData.DamageType.Blunt }, new() { m_modifier = HitData.DamageModifier.VeryResistant, m_type = HitData.DamageType.Slash }, new() { m_modifier = HitData.DamageModifier.VeryResistant, m_type = HitData.DamageType.Pierce }
    //     };
    ...
    //         new()
    //         {
    //           m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("VFX_GreenPotionDrink"), m_enabled = true, m_attach = true
    //         }
    //         , new()
    //         {
    //           m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("potionaudio"), m_enabled = true, m_attach = true
    //         }
    //       }
    //     };
      ...
      try
      {
        ...
        _magelightSestat.m_startEffects = new EffectList
        {
          m_effectPrefabs = new EffectList.EffectData[]
          {
            new()
            {
              m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("Magelight"), m_enabled = true, m_attach = true
            }
            , new()
            {
              m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("VFX_PurplePotionDrink"), m_enabled = true, m_attach = true
            }
            , new()
            {
              m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("potionaudio"), m_enabled = true, m_attach = true
    ...
    //         new()
    //         {
    //           m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("VFX_RedPotionDrink"), m_attach = true, m_enabled = true
    //         }
    //         , new()
    //         {
    //           m_prefab = PrefabManager.Cache.GetPrefab<GameObject>("potionaudio"), m_attach = true, m_enabled = true
    //         }
    //       }
    //     };
